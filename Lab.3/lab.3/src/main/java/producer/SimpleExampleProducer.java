  ...
  // private static final String OUR_BOOTSTRAP_SERVERS = "localhost:9092, localhost:9093, localhost:9094";
    ...
    public static void main(String[] args){
        ...
        try {
            ...
            LOG.info("aaaaaaaaaaaaaaaaaaaaaaaaa key = {}, value = {} ==> partition = {}, offset = {}", data.key(), data.value(), meta.partition(), meta.offset());
            ...
            LOG.info("ccccccccccccccccccccccccc key = {}, value = {} ==> partition = {}, offset = {}", data2.key(), data2.value(), meta2.partition(), meta2.offset());
